...
def class_for_type(type: NodeType) -> Any:
    if type is NodeType.FULL_NODE:
        ...
        from fibo.introducer.introducer_api import IntroducerAPI

        return IntroducerAPI
    elif type is NodeType.TIMELORD:
        from fibo.timelord.timelord_api import TimelordAPI
        ...
        from fibo.harvester.harvester_api import HarvesterAPI

...
from fibo.cmds.init_funcs import chia_init
from fibo.daemon.windows_signal import kill
from fibo.server.server import ssl_context_for_root, ssl_context_for_server
...
from fibo.util.service_groups import validate_service
from fibo.util.setproctitle import setproctitle
from fibo.util.ws_message import WsRpcMessage, create_payload, format_response
...
service_plotter = "fibo plots create"
...
class WebSocketServer:
    ...
    async def exit(self) -> Dict[str, Any]:
        ...
        log.info("fibo daemon exiting in 5 seconds")

...
from fibo.pools.pool_config import PoolWalletConfig, load_pool_config
from fibo.protocols import farmer_protocol, harvester_protocol
from fibo.protocols.pool_protocol import (
    ErrorResponse,
...
from fibo.server.server import ssl_context_for_root
from fibo.server.ws_connection import WSChiaConnection
from fibo.ssl.create_ssl import get_mozilla_ca_crt
...
from fibo.util.bech32m import decode_puzzle_hash
from fibo.util.config import load_config, save_config, config_path_for_filename
...
from fibo.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    def __init__(
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'fibo keys generate' or open the UI."

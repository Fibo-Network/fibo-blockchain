...
from fibo.wallet.cc_wallet import cc_utils
from fibo.wallet.cc_wallet.cc_utils import CC_MOD, SpendableCC, spend_bundle_for_spendable_ccs, uncurry_cc
from fibo.wallet.cc_wallet.cc_wallet import CCWallet
from fibo.wallet.puzzles.genesis_by_coin_id_with_0 import genesis_coin_id_for_genesis_coin_checker
from fibo.wallet.trade_record import TradeRecord
from fibo.wallet.trading.trade_status import TradeStatus
from fibo.wallet.trading.trade_store import TradeStore
from fibo.wallet.transaction_record import TransactionRecord
from fibo.wallet.util.trade_utils import (
                ...
                if my_cc_spends is None or my_cc_spends == set():
                    ...
                    if zero_spend_bundle is None:
                        return (
                            False,
                            None,
                            "Unable to generate zero value coin. Confirm that you have fibo available",
                        )

...
from fibo.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "fibo" in cc_discrepancies:
                    cc_discrepancies["fibo"] = cc_discrepancies["fibo"] + diff
                else:
                    cc_discrepancies["fibo"] = diff

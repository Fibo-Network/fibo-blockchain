...
from fibo.cmds.configure import configure_cmd
from fibo.cmds.farm import farm_cmd
from fibo.cmds.init import init_cmd
from fibo.cmds.keys import keys_cmd
from fibo.cmds.netspace import netspace_cmd
from fibo.cmds.plots import plots_cmd
from fibo.cmds.show import show_cmd
from fibo.cmds.start import start_cmd
from fibo.cmds.stop import stop_cmd
from fibo.cmds.wallet import wallet_cmd
from fibo.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage fibo blockchain infrastructure ({__version__})\n",
    epilog="Try 'fibo start node', 'fibo netspace -d 192', or 'fibo show -s'",
...
@cli.command("version", short_help="Show fibo version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs fibo daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from fibo.daemon.server import async_run_daemon
    import asyncio

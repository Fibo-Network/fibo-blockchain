...
from fibo.cmds.init_funcs import check_keys
from fibo.consensus.block_rewards import calculate_base_farmer_reward
from fibo.pools.pool_wallet import PoolWallet
from fibo.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from fibo.protocols.protocol_message_types import ProtocolMessageTypes
from fibo.server.outbound_message import NodeType, make_msg
from fibo.simulator.simulator_protocol import FarmNewBlockProtocol
from fibo.types.blockchain_format.coin import Coin
from fibo.types.blockchain_format.sized_bytes import bytes32
from fibo.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from fibo.util.byte_types import hexstr_to_bytes
from fibo.util.ints import uint32, uint64
from fibo.util.keychain import bytes_to_mnemonic, generate_mnemonic
from fibo.util.path import path_from_root
from fibo.util.ws_message import WsRpcMessage, create_payload_dict
from fibo.wallet.cc_wallet.cc_wallet import CCWallet
from fibo.wallet.derive_keys import master_sk_to_singleton_owner_sk
from fibo.wallet.rl_wallet.rl_wallet import RLWallet
from fibo.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from fibo.wallet.did_wallet.did_wallet import DIDWallet
from fibo.wallet.trade_record import TradeRecord
from fibo.wallet.transaction_record import TransactionRecord
from fibo.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from fibo.wallet.util.trade_utils import trade_record_to_dict
from fibo.wallet.util.transaction_type import TransactionType
from fibo.wallet.util.wallet_types import WalletType
from fibo.wallet.wallet_info import WalletInfo
from fibo.wallet.wallet_node import WalletNode
from fibo.util.config import load_config
from fibo.consensus.coinbase import create_puzzlehash_for_pk
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from fibo.pools.pool_wallet_info import initial_pool_state_from_dict

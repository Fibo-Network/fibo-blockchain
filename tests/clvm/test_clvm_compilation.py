...
from fibo.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "fibo/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "fibo/wallet/puzzles/cc.clvm",
        "fibo/wallet/puzzles/chialisp_deserialisation.clvm",
        "fibo/wallet/puzzles/rom_bootstrap_generator.clvm",
        "fibo/wallet/puzzles/generator_for_single_coin.clvm",
        "fibo/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "fibo/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "fibo/wallet/puzzles/lock.inner.puzzle.clvm",
        "fibo/wallet/puzzles/p2_conditions.clvm",
        "fibo/wallet/puzzles/p2_delegated_conditions.clvm",
        "fibo/wallet/puzzles/p2_delegated_puzzle.clvm",
        "fibo/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "fibo/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "fibo/wallet/puzzles/p2_puzzle_hash.clvm",
        "fibo/wallet/puzzles/rl_aggregation.clvm",
        "fibo/wallet/puzzles/rl.clvm",
        "fibo/wallet/puzzles/sha256tree_module.clvm",
        "fibo/wallet/puzzles/singleton_top_layer.clvm",
        "fibo/wallet/puzzles/did_innerpuz.clvm",
        "fibo/wallet/puzzles/decompress_puzzle.clvm",
        "fibo/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "fibo/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "fibo/wallet/puzzles/block_program_zero.clvm",
        "fibo/wallet/puzzles/test_generator_deserialize.clvm",
        "fibo/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "fibo/wallet/puzzles/p2_singleton.clvm",
        "fibo/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "fibo/wallet/puzzles/pool_member_innerpuz.clvm",
        "fibo/wallet/puzzles/singleton_launcher.clvm",
        "fibo/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["fibo/wallet/puzzles/create-lock-puzzlehash.clvm", "fibo/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "fibo/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to fibo/wallet/puzzles, but not added to `wallet_program_files`
        """
